...
const config = {
    serverInfo: {
        ...
        serverName: "Lythia.de", /*Server name*/
        serverIp: "Lythia.de", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "876068862754447391" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    atGroupsDefaultColors: {
        ...
        Mods: "rgba(11, 175, 255, 0.5)",
	    Sup: "rgba(39, 140, 245, 0.61)",
    ...
    adminTeamPage: {
        leaders: [
            ...
            {
                inGameName: "Spidzn",
                rank: "Team Leitung / Admin",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(215, 0, 0, 1)"
            },
           {
                inGameName: "Redstoner0907",  // Added closing double quote
                rank: "Admin",
                skinUrlOrPathToFile: "",
                 rankColor: "rgba(106, 20, 9, 1)"
           }
        ],
        //developers: [
        //    {
        ...
        Moderator: [
            {
                inGameName: "fabkill",
                rank: "Mod/Ideenbringer",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(43, 27, 168, 1)"
            },
            {
                inGameName: "Jeanmichelswiss",
                rank: "Mod",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(43, 27, 168, 1)"
            },
	    ...
	    Supporter: [
            {
                inGameName: "Big_L_1502",
                rank: "Supporter",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(0, 163, 213, 1)"
            }
        //    {
         //       inGameName: "MrTechnoTW",
         //       rank: "Admin",
          //      skinUrlOrPathToFile: "",
          //      rankColor: "rgba(106, 20, 9, 1)"
         //   },
        //    {
        //        inGameName: "Batman1710",
         //       rank: "Admin",
         //       skinUrlOrPathToFile: "",
         //       rankColor: "rgba(106, 20, 9, 1)"
         //   },
         //  {
          //      inGameName: "Spidzn2102",
           //     rank: "Admin",
           //     skinUrlOrPathToFile: "",
           //     rankColor: "rgba(106, 20, 9, 1)"
           // }
...
Rest: [
            {
                ...
                rank: "Jr Builder",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(0, 255, 0, 1)"
            },
            {
                inGameName: "RexToastBrot",
                rank: "Jr Builder",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(0, 255, 0, 1)"
            },
            {
                inGameName: "Quipper007",
                rank: "Helfer",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(197, 119, 0, 1)"
            },
            {
                inGameName: "Minexo_420",
                rank: "Partner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(0, 118, 0, 1)"
            }
         ],
    },
